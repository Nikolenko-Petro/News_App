...
var _calendarFetch = require("./js/calendar/calendarFetch");
var _burgerMenu = require("./js/header/burger-menu");
var _favoritButton = require("./js/favorit/favoritButton");
var _pagination = require("./js/pagination/pagination");
var _favoriteToLocalStorage = require("./js/favorit/favoriteToLocalStorage");
...
(0, _newsFetch.getNews)("mostPopular").then((resp)=>{
    const markup = (0, _createMarkup.createMarkup)(resp.data.results, "popularCards");
    (0, _renderMarkup.renderMarkup)(refs.newsList, markup);
...
;
var _axiosDefaults = require("../axios/axiosDefaults");
...
async function getNews(pathName, parameters, category) {
    ...
    try {
        const response = await (0, _axiosDefaults.axiosNews).get(path[pathName], {
            params: parameters
        });
        return response;
    } catch (error) {
        (0, _notiflix.Notify).failure(error);
    }
}

},{"../axios/axiosDefaults":"94KhP","notiflix":"5z0Oc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"94KhP":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "axiosWeather", ()=>axiosWeather);
parcelHelpers.export(exports, "axiosNews", ()=>axiosNews);
...
const axiosWeather = (0, _axiosDefault.default).create({
...
function randomKey() {
    ...
    if (random > 5) return KEYS.NEWS;
    else return KEYS.NEWS_2;
}
const axiosNews = (0, _axiosDefault.default).create({
...
},{}],"hd7ZQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function createMarkup(data, markupName) {
    ...
    if (markupName === "dateCards") {
        ...
        let normalDate;
        markupArr = data.flatMap((el)=>{
            if (el.multimedia.length !== 0) imageUrl = IMAGES_URL + el.multimedia[0].url;
            else imageUrl = "https://t4.ftcdn.net/jpg/00/38/13/73/240_F_38137330_gUbR3ZXBc5J5g4pRkaC8TYZQA62OZhx5.jpg";
    ...
    if (markupName === "categoryCards") {
        ...
        markupArr = data.flatMap((el)=>{
            if (el.multimedia) {
                if (el.multimedia.length >= 3) imageUrl = el.multimedia[2].url;
                else imageUrl = "https://t4.ftcdn.net/jpg/00/38/13/73/240_F_38137330_gUbR3ZXBc5J5g4pRkaC8TYZQA62OZhx5.jpg";
            } else imageUrl = "https://t4.ftcdn.net/jpg/00/38/13/73/240_F_38137330_gUbR3ZXBc5J5g4pRkaC8TYZQA62OZhx5.jpg";
    ...
    if (markupName === "categoriesForDesktop") markupArr = data.map((el, idx)=>{
        if (idx >= 7 || idx === 0) return;
        else return `<li class="categories-link-desktop" data-search=${el.section}><button class="btn-desktop">${el.display_name}</button></li>`;
    });
    if (markupName === "categoriesFull") markupArr = data.flatMap((el, idx)=>{
        return `<li class="categories-menu-link" data-search=${el.section}><button class="btn-menu">${el.display_name}</button></li>`;
    });
    if (markupName === "weather") markupArr = data.flatMap((el)=>{
        return `
    ...
    if (markupName === "pagination") // createMarkup(8, "pagination")
    for(let i = 1; i <= data; i += 1)markupArr.push(`<li class="pagination-item">${i}</li>`);
    markup[markupName] = markupArr.join("");
    return markup[markupName];
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"flc1Q":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderMarkup", ()=>renderMarkup) // Пример рендера most popular news на главную страницу:
...
},{}],"8oxyq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class SimpleCalendar extends SCDate {
    constructor({ fromYear , toYear , defaultDate  }){
        ...
        this.refs.monthItems.addEventListener("click", this.#onSelectMonth.bind(this));
    ...
    `;
     ...
     #highlightCurrentMonth() {
        ...
        [
            ...
            if (item.classList.contains("js-accent")) item.classList.remove("js-accent");
            if (Number(item.dataset["value"]) === currentMonth) item.classList.add("js-accent");
        });
    }
     #onOpenCalendar(e) {
     ...
     #onSelectMonth(e3) {
        let value;
        if (e3.target.nodeName === "SPAN") value = e3.target.parentNode.dataset["value"];
        else if (e3.target.nodeName === "LI") value = e3.target.dataset["value"];
        else return;
     ...
     #onSelectDate(e6) {
        let keys = [];
        let value;
        if (e6.target.nodeName === "P") {
            keys = Object.keys(e6.target.parentNode.dataset);
            value = e6.target.parentNode.dataset["value"];
        } else if (e6.target.nodeName === "LI") {
            keys = Object.keys(e6.target.dataset);
...
(0, _calendar.addEventListenerToChangeDate)((e)=>{
    let size;
    const date = (0, _calendar.getDate)("yyyymmdd");
    const chooseDate = new Date((0, _calendar.getDate)("yyyy-mm-dd"));
    const dateNow = Date.now();
    if (dateNow <= chooseDate.getTime()) {
        (0, _notiflix.Notify).warning("You can`t see into the future, it`s a pity!");
        return;
    } else (0, _newsFetch.getNews)("articles", {
        begin_date: date,
        end_date: date
    }).then((resp)=>{
        refs.newsList.innerHTML = "";
        (0, _renderMarkup.renderMarkup)(refs.newsList, (0, _createMarkup.createMarkup)(resp.data.response.docs, "dateCards"));
        (0, _checkBtnId.checkBtnId)();
        size = Math.ceil(resp.data.response.meta.hits / 10);
        if (size > 99) size = 99;
        (0, _pagination.init)(size);
        ...
        (0, _fromFetchToLocalStorage.addFetchedToLocalStorage)(resp);
        (0, _haveReadOnHome.haveRead).checkFetchedNewsByID(resp);
    });
});
...
var Pagination = {
    ...
    First: function() {
        ...
        else Pagination.code += "<a>1</a><i>...</i>";
    },
    // --------------------
    // Handlers
    // --------------------
 ...
 * * * * * * * * * * * * * * * * */ var init = function(size) {
    if (window.innerWidth < 768) Pagination.Init(document.getElementById("pagination"), {
        size,
        page: 1,
        step: 1
    });
    else Pagination.Init(document.getElementById("pagination"), {
        size,
        page: 1,
        step: 2
    });
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kNjUq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "showNoNewsSection", ()=>showNoNewsSection);
...
function addRemoveHandler(event) {
    if (event.target.classList.contains("news__readmore-link")) {
        (0, _addToRead.handleReadMoreBtnClick)(event);
        (0, _haveReadOnHome.addHaveReadStylesForCard)(event);
    }
...
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _axiosDefaults = require("../axios/axiosDefaults");
var _weatherSvg = require("./weather-svg");
let svgWeather = "";
...
class Weather {
    constructor(){
        this.options = {
            ...
            params: {
                lat: null,
                lon: null,
                appid: (0, _axiosDefaults.KEYS).WEATHER,
                units: "metric"
            }
        };
    ...
    async getWeather() {
        const response = await (0, _axiosDefault.default).get(`${this.options.baseURL}`, this.options);
        return response.data;
    }
    async checkUserGeo() {
        const response = await (0, _axiosDefault.default)(`${this.IP_API_URL}`);
        return response.data;
    }
    checkNavPermissions() {
        if (navigator.geolocation) return navigator.geolocation.getCurrentPosition(onSuccess, onError);
        else alert("Your browser not support geolocation api");
    }
    renderWeatherMarkup(data) {
        ...
        switch(data.weather[0].icon){
            case "01d":
                svgWeather = (0, _weatherSvg.clearDay);
                break;
            case "01n":
                svgWeather = (0, _weatherSvg.clearNight);
                break;
            case "02d":
                svgWeather = (0, _weatherSvg.partlyCloudDay);
                break;
            case "02n":
                svgWeather = (0, _weatherSvg.partlyCloudNigtht);
                break;
            case "03d":
                svgWeather = (0, _weatherSvg.partlyCloudDay);
                break;
            ...
            case "04n":
                ...
                break;
            case "09d":
                svgWeather = (0, _weatherSvg.rain);
                break;
            case "09n":
                svgWeather = (0, _weatherSvg.rain);
                break;
            case "10d":
                svgWeather = (0, _weatherSvg.partlyCloudDayRain);
                break;
            case "10n":
                svgWeather = (0, _weatherSvg.partlyCloudNigthtRain);
                break;
            case "11d":
                svgWeather = (0, _weatherSvg.storm);
                break;
            case "11n":
                svgWeather = (0, _weatherSvg.storm);
                break;
            case "13d":
                svgWeather = (0, _weatherSvg.partlyCloudSnow);
                break;
            case "13n":
                svgWeather = (0, _weatherSvg.partlyCloudSnow);
                break;
            case "50d":
                svgWeather = (0, _weatherSvg.fog);
                break;
            case "50n":
                svgWeather = (0, _weatherSvg.fog);
                break;
...
async function onError(error) {
    const userGeo = await weather.checkUserGeo().then((response)=>{
...
var _checkBtnIdJs = require("./favorit/checkBtnId.js");
...
(0, _newsFetchJs.getNews)("allCategories").then((resp)=>{
    (0, _renderMarkupJs.renderMarkup)(categoriesMenu, (0, _createMarkupJs.createMarkup)(resp.data.results, "categoriesFull"));
    (0, _renderMarkupJs.renderMarkup)(categoriesBtn, (0, _createMarkupJs.createMarkup)(resp.data.results, "categoriesForDesktop"), "afterbegin");
});
function getCategoriesNews(e) {
    if (e.target.classList.contains("btn-menu") || e.target.classList.contains("btn-desktop")) (0, _newsFetchJs.getNews)("category", {}, e.target.textContent.toLowerCase()).then((resp)=>{
        newsListRef.innerHTML = "";
        (0, _renderMarkupJs.renderMarkup)(newsListRef, (0, _createMarkupJs.createMarkup)(resp.data.results, "categoryCards"));
        window.localStorage.setItem("lastFetchType", JSON.stringify({
            type: "category",
            value: e.target.textContent.toLowerCase()
        }));
        (0, _checkBtnIdJs.checkBtnId)();
        return resp.data.results;
    }).then((results)=>{
        (0, _fromFetchToLocalStorage.addFetchedToLocalStorage)(results);
        (0, _haveReadOnHome.haveRead).checkFetchedNewsByID(results);
...
function renderActiveBtn(e) {
    ...
    if (e.target.nodeName !== "BUTTON") return;
        ...
        if (activeBtnColor) activeBtnColor.classList.remove("is-active");
        else if (activeBtnLine) activeBtnLine.classList.remove("active-underline");
        ...
        (0, _newsFetchJs.getNews)("category", {
            limit: 500
        }, e.target.textContent.toLowerCase()).then((resp)=>{
            (0, _paginationJs.init)(Math.ceil(resp.data.results.length / 10));
        });
        (0, _newsFetchJs.getNews)("category", {
            limit: 10
        }, e.target.textContent.toLowerCase()).then((resp)=>{
            (0, _renderMarkupJs.renderMarkup)(newsListRef, (0, _createMarkupJs.createMarkup)(resp.data.results, "categoryCards"));
            (0, _emptyFetchJs.showNoNewsSection)(resp.data.results);
            window.localStorage.setItem("lastFetchType", JSON.stringify({
                type: "category",
                value: e.target.textContent.toLowerCase()
            }));
        ...
        if (activeBtnLine) activeBtnLine.classList.remove("active-underline");
        else if (activeBtnColor) activeBtnColor.classList.remove("is-active");
...
function fetchPagination(e) {
    ...
    if (lastFetch.type === "input") {
        ...
        (0, _newsFetch.getNews)("articles", oprions).then((resp)=>{
            newsListRef.innerHTML = "";
            (0, _renderMarkup.renderMarkup)(newsListRef, (0, _createMarkup.createMarkup)(resp.data.response.docs, "inputsCards"));
        });
        ...
        (0, _newsFetch.getNews)("category", oprions, lastFetch.value).then((resp)=>{
            newsListRef.innerHTML = "";
            (0, _renderMarkup.renderMarkup)(newsListRef, (0, _createMarkup.createMarkup)(resp.data.results, "categoryCards"));
        });
        ...
        (0, _newsFetch.getNews)("articles", oprions).then((resp)=>{
            newsListRef.innerHTML = "";
            (0, _renderMarkup.renderMarkup)(newsListRef, (0, _createMarkup.createMarkup)(resp.data.response.docs, "dateCards"));
        });
    }
} // ПО INPUT
 // CATEGORY
